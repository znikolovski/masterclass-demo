...
/**
 * Named Target mbox scopes from authored zone markers. Required when the Target
 * property disables auto page-load mbox and activities use explicit locations
 * (e.g. data-targetlocation="homepage-hero-mbox").
 * @param {Document} doc
 * @returns {string[]}
 */
